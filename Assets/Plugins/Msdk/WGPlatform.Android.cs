...
namespace Msdk
{
	...
	{	  
		...
		private AndroidJavaClass GetUnityPlayer()
		{
			if (unityPlayer == null) 
			{
				unityPlayer = new AndroidJavaClass(className);
			}
			return unityPlayer;
		}
	    ...
	    {
				GetUnityPlayer().CallStatic("LoginQQ");	        
	    }
		//登录微信,回调是loginNotify
		public void WGLoginWX()
		{
			GetUnityPlayer().CallStatic("LoginWX");		
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("QueryMyQQInfo");
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("QueryQQGameFriendsInfo");
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToQQ_Qzone", title, desc, url, imgUrl, imgUrlLen);
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToQQ_Session", title, desc, url, imgUrl, imgUrlLen);
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToQQWithMusic_Session", title, desc, musicUrl, musicDataUrl, imgUrl);		
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToQQWithMusic_Qzone", title, desc, musicUrl, musicDataUrl, imgUrl);
		}
		...
		{
				return GetUnityPlayer().CallStatic<bool>("SendToQQGameFriend", act, friendOpenId, title, summary,  targetUrl,  imageUrl,  previewText, gameTag);
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToQQWithPhoto_Session", imgFilePath);
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToQQWithPhoto_Qzone", imgFilePath);
		}
		...
		{
			GetUnityPlayer().CallStatic("AddGameFriendToQQ", fopenid, desc, message);
		}
		/// <summary>
		...
		{
			GetUnityPlayer().CallStatic("BindQQGroup", unionid, union_name, zoneid, signature);
		}
		...
		{
			GetUnityPlayer().CallStatic("JoinQQGroup", qqGroupKey);
		}
		...
		{
			GetUnityPlayer().CallStatic("OpenUrl", url);
		}
		...
		public void WGReportEvent(string name, Dictionary<string, string> data, bool isRealTime) 
		{
			...
			GetUnityPlayer().CallStatic("ReportEvent", name, jsonData, isRealTime);
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("QueryMyWXInfo");			
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("QueryWXGameFriendsInfo");			
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToWeixin_Session", title, desc, mediaTagName, 
		...
		{
			GetUnityPlayer().CallStatic("SendToWeixinWithPhoto_Session", mediaTagName, imgData, imgDataLen, messageExt, mediaAction);
		}
		...
		public void WGSendToWeixinWithPhoto_Moment(string mediaTagName, byte[] imgData,
		                                                     int imgDataLen, string messageExt,string mediaAction)
		{
			GetUnityPlayer().CallStatic("SendToWeixinWithPhoto_Moment", mediaTagName, imgData, imgDataLen, messageExt, mediaAction);		
		}
		...
		{
			GetUnityPlayer().CallStatic("SendToWeixinWithMusic_Session", title,  desc, musicUrl, musicDataUrl,
		...
		public void WGSendToWeixinWithMusic_Moment(string  title, string  desc, string musicUrl, string musicDataUrl,
		                                                 string mediaTagName, byte[] imgData, int imgDataLen, string messageExt, string messageAction)
		{
			GetUnityPlayer().CallStatic("SendToWeixinWithMusic_Moment", title,  desc, musicUrl, musicDataUrl,
				                       mediaTagName, imgData, imgDataLen, messageExt, messageAction);
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("SendToWXGameFriend",  fopenid,  title,  description,
		...
		{
			GetUnityPlayer().CallStatic("RefreshWXToken");			
		}
		...
		{
			GetUnityPlayer().CallStatic("ShowNotice", scene);			
		}
		...
		{
			return GetUnityPlayer().CallStatic<string>("GetNoticeData", scene);			
		}
		...
		{
			GetUnityPlayer().CallStatic("HideScrollNotice");			
		}
		...
		{
			GetUnityPlayer().CallStatic("GetNearbyPersonInfo");			
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("CleanLocation");
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("GetLocationInfo");
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("IsPlatformInstalled", platform);
		}
		...
		{
			return GetUnityPlayer().CallStatic<string>("GetPlatformAPPVersion", platform);
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("CheckApiSupport", api);	
		}
		...
		{
			return GetUnityPlayer().CallStatic<string>("GetVersion");
		}
		...
		public string WGGetChannelId() {
				return GetUnityPlayer().CallStatic<string>("GetChannelId");
		}
		...
		public string WGGetRegisterChannelId() {
				return GetUnityPlayer().CallStatic<string>("GetRegisterChannelId");
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("SwitchUser", switchToLaunchUser);			
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("Logout");			
		}
		...
		{
			GetUnityPlayer().CallStatic("EnableCrashReport", bRdmEnable, bMtaEnable);			
		}
		...
		{
			return GetUnityPlayer().CallStatic<string>("GetPf", gameCustomInfo);			
		}
		...
		{
			return GetUnityPlayer().CallStatic<string>("GetPfKey");		
		}
		...
		{
			GetUnityPlayer().CallStatic("LoginWithLocalInfo");
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("OpenAmsCenter", param);			
		}
		...
		{
			return GetUnityPlayer().CallStatic<bool>("Feedback", game, txt);			
		}
		...
		{
			GetUnityPlayer().CallStatic("Feedback", body);			
		}
		...
		{
			GetUnityPlayer().CallStatic("CheckNeedUpdate");			
		}
		...
		{
			return GetUnityPlayer().CallStatic<int>("CheckYYBInstalled");			
		}
		...
		{
			GetUnityPlayer().CallStatic("StartCommonUpdate");			
		}
		...
		{
			GetUnityPlayer().CallStatic("StartSaveUpdate");			
		}
		...
		{
			GetUnityPlayer().CallStatic("ShowAD", adType);		
		}
